...
def carregar_mais(page, num_clicks=1):
    for _ in range(num_clicks):
        try:
            # Clique no botão "mostrar mais"
            button = page.locator('xpath=/html/body/div[3]/section[1]/div/div/div/div/div[1]/div[2]/div[2]/div[2]/div/div/div/button')
            button.click()
            time.sleep(1)  # Aguarda para garantir que os novos dados foram carregados
...
def collect_data(url):
    ...
    with sync_playwright() as p:
        ...
        # Clicar no botão "mostrar mais" antes de coletar os dados
        carregar_mais(page)
    ...
    for content in contents:
        ...
        # Pegar texto
        if edificio and endereco and ul_items:
            ...
            data.append({
                ...
                "vagas": vagas_text,
                "preco": preco_text,
                "imobiliaria": "Inglaterra"
            })
    return data

# Exemplo de uso
'''url = 'https://www.imobiliariainglaterra.com.br/imoveis/para-alugar/apartamento/londrina?finalidade=residencial'
